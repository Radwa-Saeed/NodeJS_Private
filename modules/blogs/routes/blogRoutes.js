...
const { getallblogs, addblog, updateblog, deleteallblogs, return_deletedblogs, getblog_id, getblog_titlecontent, getblog_user } = require("../controllers/blogControllers");
...
router.get("/getallblogs-today",getallblogs)  // localhost:5000/getallblogs-today
router.get("/getallblogs-yesterday",getallblogs)  // localhost:5000/getallblogs-yesterday
